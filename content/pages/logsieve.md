...
Template: product
Status: hidden
Summary: Analyze, filter, and explore log files entirely in the browser. Nothing leaves your device — built for air-gapped environments and regulated industries. MIT licensed.
  ...
  <div class="container">
    <div class="hero-inner">
      <div class="hero-content">
        ...
        <h1>LogSieve</h1>
        <p>In-browser log exploration and filtering that runs entirely in the browser. Load your log files, filter, search, and analyze — nothing leaves your device, nothing goes to a server.</p>
        <div class="cta-row">
  ...
  <div class="container">
    ...
    <div class="grid">
      ...
      <article class="card">
        ...
        <h3>Filter &amp; Search</h3>
        <p>Filter log lines by pattern, level, timestamp range, or custom criteria. Find the signal in large log files without writing grep scripts.</p>
      </article>
      <article class="card">
  ...
  <div class="container">
    ...
    <div class="grid">
      <article class="card">
        ...
        <p>Pull logs off a compromised system, open LogSieve locally, and analyze without routing evidence through your corporate proxy or logging pipeline.</p>
      </article>
      <article class="card">
      ...
      <article class="card">
        ...
        <p>Engineers troubleshooting production issues can load multi-MB log files directly in the browser without waiting for a SIEM query to return.</p>
      </article>
    </div>
  </div>
</section>
